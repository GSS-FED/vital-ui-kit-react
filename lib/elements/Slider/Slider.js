...
import React, { type Node, Component, ReactElement } from 'react';
import ResizeObserver from 'resize-observer-polyfill';

import Icon from '../Icon/';
import { Root, Wrapper, Track, Selection, Handler, Button } from './styled';
...
type Props = {
  ...
  value: number,
  disabled?: boolean,
  decreaseButton?: ReactElement,
  increaseButton?: ReactElement,
    ...
    return (
      ...
      >
        ...
        <Wrapper size={this.props.size} disabled={this.props.disabled}>
          ...
          <Selection
            size={this.props.size}
            width={position - this.state.grab}
          />
          <Handler
            size={this.props.size}
            innerRef={s => {
