...
const Btn = styled.button(
  ...
  _a => {
    const subtle = _a.subtle;
    const selected = _a.selected;
    const theme = _a.theme;
    const nature = _a.nature;
    return (
      subtle &&
      css(
        ...
        selected ? theme.button.subtle.bg : 'transparent',
        nature === 'default'
          ? theme.button.subtle.color
          : natureColor(theme)[nature],
        theme.button.subtle.hoverBg,
      )
    );
  },
  _a => {
  ...
  _a => {
    ...
    return (
      ...
      css(
        ...
        theme.button.light.bg,
        natureColor(theme)[nature],
        theme.button.light.hoverBg,
      )
    );
  },
  _a => {
    ...
    return (
      ...
      css(
        ...
        theme.button.link.bg,
        theme.button.link.color,
        theme.button.link.hoverBg,
        theme.button.link.hoverColor,
      )
    );
  },
  _a => {
    ...
    return (
      ...
      css(
        ...
        theme.button.link.darkColor,
        theme.button.link.hoverDarkColor,
      )
    );
  },
  _a => {
