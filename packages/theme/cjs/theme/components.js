...
var defaultTheme = _interopRequireWildcard(_variables);
  ...
  return {
    ...
    button: {
      ...
      link: {
        ...
        hoverColor: (0, _polished.lighten)(0.1, theme.primary500),
        hoverDarkColor: (0, _polished.lighten)(0.1, theme.secondary700)
      },
      disabled: {
        color: '#93a8ce',
        borderColor: '#eaeff8',
    ...
    card: {
      ...
      button: {
        bg: theme.white,
        color: function color(isPrimary) {
          return isPrimary ? theme.primary500 : theme.secondary700;
        },
        hover: theme.secondary300
      }
    },
    checkbox: {
      boxShadow: '0 0 0 2px ' + (0, _polished.rgba)(theme.secondary, 0.2),
      borderColor: theme.secondary400,
      checkedBorderColor: theme.secondary,
      bg: function bg(isCheckAndRound) {
        return isCheckAndRound ? theme.primary500 : theme.white;
      },
      label: {
        color: theme.secondary700
      },
    ...
    pill: {
      bg: function bg(selected) {
        return selected ? '#2A4880' : 'transparent';
      },
      color: function color(selected) {
        return selected ? theme.white : '#456296';
      },
      hover: {
        bg: '#d8e2f5',
        color: '#456296'
    ...
    radio: {
      color: function color(disabled) {
        return disabled ? theme.secondary : theme.secondary700;
      },
    ...
    tab: {
      ...
      item: {
        color: theme.white,
        bg: (0, _polished.rgba)(255, 255, 255, 0.3),
        current: {
          color: theme.secondary700,
          bg: theme.white
        }
