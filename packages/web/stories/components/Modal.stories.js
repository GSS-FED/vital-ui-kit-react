...
storiesOf('Components | Modal', module)
  ...
  class ModalExample extends Component {
    ...
    render() {
      return (
        <Fragment>
          <Button subtle onClick={() => this.setState({ showModal: true})}>Show</Button>
          <Modal show={this.state.showModal}>
            <Card width="300px" height="220px">
              ...
              <Card.Footer>
                <Card.FooterButton onClick={() => this.setState({ showModal: false})}>Cancel</Card.FooterButton>
                <Card.FooterButton primary onClick={() => this.setState({ showModal: false})}>Confirm</Card.FooterButton>
              </Card.Footer>
            </Card>
          </Modal>
        </Fragment>
